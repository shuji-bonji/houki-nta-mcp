...
import { parseTsutatsuTocHojin } from '../dist/services/tsutatsu-toc-parser-hojin.js';

const html = readFileSync(process.argv[2], 'utf8');
const toc = parseTsutatsuTocHojin(html, 'https://www.nta.go.jp/law/tsutatsu/kihon/hojin/01.htm');
