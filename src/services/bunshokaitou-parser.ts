...
// 0.20.1 で本ファイルに置いた 2 関数は 0.20.2 で nta-navigation-text.ts に移した。呼び出し側のために再 export する
export { isNtaNavigationText, stripNtaNavigationLines } from './nta-navigation-text.js';
